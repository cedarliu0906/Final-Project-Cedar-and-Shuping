...
```{python}
rec_path = 'D:/Github/Final-Project-Cedar-and-Shuping/renewable_energy_china.csv'
...
```{python}
cec_path = 'D:/Github/Final-Project-Cedar-and-Shuping/carbon_emission_china.csv'
...
```{python}
gdp_path = 'D:/Github/Final-Project-Cedar-and-Shuping/gdp_china.csv'
...
province_shp_path = "D:/Github/Final-Project-Cedar-and-Shuping/ChinaAdminDivisonSHP/2. Province/province.shp" 
...
china_map_translated.to_file("D:/Github/Final-Project-Cedar-and-Shuping/ChinaAdminDivisonSHP/2. Province/translated_province.shp", driver="ESRI Shapefile")
...
```{python}
province_shp_path = "D:/Github/Final-Project-Cedar-and-Shuping/ChinaAdminDivisonSHP/2. Province/translated_province.shp"
